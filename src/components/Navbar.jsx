  ...
  return (
    <div className=" shadow-md w-full fixed top-0 left-0 z-50">
      <div className=" md:px-10  py-4 px-7 md:flex justify-between items-center bg-blue-100 relative">
        ...
        {/* Navigation Links */}
        <ul
          className={`md:flex md:items-center md:pb-0 pb-5 right-0 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
            isOpen
              ? "top-13 z-10  bg-blue-100 opacity-90"
              : "top-[-490px] z-0 w-full "
          }`}
        >
