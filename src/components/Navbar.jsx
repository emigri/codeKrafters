  ...
  return (
    <div className=" shadow-md w-full fixed top-0 left-0">
      <div className=" md:px-10  py-4 px-7 md:flex justify-between items-center bg-blue-100 relative">
       ...
       {/* Navigation Links */}
        <ul className= {` nav-links md:flex pl-9 md:pl-0 md:items-center md:pb-0 pb-5 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all bg-blue-100 duration-500 ease-in ${isOpen ? 'top-13' : 'top-[-490px]'}`}>
          {navLinks.map((link, index) => (
            <li className=" font-semibold my-7 md:my-0 md:ml-8 text-blue-800 hover:text-blue-400" key={index}>
