      ...
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="max-w-2xl">
          ...
          {developers.map((developer) => {
            return (
              <>
                <a key={Math.floor(Math.random() * 100000)}
                  href="#"
                ...
                >
                  ...
                  <div className="flex flex-col justify-between p-4 leading-normal" 
                    key={Math.floor(Math.random() * 100000)}>
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white" key={Math.floor(Math.random() * 100000)}>
                      {developer}
                    </h5>
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400" key={Math.floor(Math.random() * 100000)}>
                      Junior Developer
                    </p>
                  </div>
                </a>
